...
//Bonus 2 -
//determins and prints whether it's unique or not
if (sq.isUnique()) {
    System.out.println("This 2D array is unique");
} else {
    System.out.println("This 2D array is not unique");
}

//Bonus 1 -
//Makes each number in the square a random number
sq.randomSquare();
sq.printSquare();
